...
<?php if (!empty($AlreadyAdded)) {  echo $AlreadyAdded; } ?></div>
    ...
    <?php
$result = mysqli_query($con,"SELECT * FROM `service_list` where code='shci06'");
        ...
        <div class="container" >
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow">
                    <div class="team-item" style="overflow: auto;">
                        ...
                        <div class="bg-light text-center p-4" style="overflow: auto;">
                            <h5 class="fw-bold mb-0">Second Hand Car Inspection</h5>
          ...
          <!-- <p class="card-text"><small class="text-muted"><a href="booking.php"><button type="button" class="btn btn-outline-success">Select</button></a></small></p></small> -->
                ...
                <?php
$result = mysqli_query($con,"SELECT * FROM `service_list` where code='abi06'");
while($row = mysqli_fetch_assoc($result)){
  ...
  ?>
                <div class="col-lg-3 col-md-6 wow">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">ABS Issue</h5>
                            <small><p class="card-text"> <ul><li>1000 Kms or 1 Month Warranty</li><li>5000 Kms or 3 Months Warranty</li></ul></p>
                                                <p><i class="fa fa-check text-success me-3"></i>Interior Vaccuming(Carpet & Seats)</p>
                                 <p><i class="fa fa-check text-success me-3"></i>Engine Oil Replacement</p>
                            <p><i class="fa fa-check text-success me-3"></i>Oil Filter Replacement</P>
          ...
          <!-- <p class="card-text"><small class="text-muted"><button type="button" class="btn btn-outline-success">Select</button></small></p></small> -->
                ...
                <?php
$result = mysqli_query($con,"SELECT * FROM `service_list` where code='fe06'");
while($row = mysqli_fetch_assoc($result)){
  ...
  ?>
                <div class="col-lg-3 col-md-6 wow">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Faulty Electricals</h5>
                            <small><p class="card-text"> <ul><li>1000 Kms or 1 Month Warranty</li><li>5000 Kms or 3 Months Warranty</li></ul></p>
                                                <p><i class="fa fa-check text-success me-3"></i>Interior Vaccuming(Carpet & Seats)</p>
                                 <p><i class="fa fa-check text-success me-3"></i>Engine Oil Replacement</p>
                            <p><i class="fa fa-check text-success me-3"></i>Oil Filter Replacement</P>
          ...
          <!-- <p class="card-text"><small class="text-muted"><button type="button" class="btn btn-outline-success">Select</button></small></p></small> -->
                ...
                <?php
$result = mysqli_query($con,"SELECT * FROM `service_list` where code='nwcss06'");
while($row = mysqli_fetch_assoc($result)){
  ...
  ?>
                <div class="col-lg-3 col-md-6 wow">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Noises with Car Suspension & Steering
</h5>
                            <small><p class="card-text"> <ul><li>1000 Kms or 1 Month Warranty</li><li>5000 Kms or 3 Months Warranty</li></ul></p>
                                                <p><i class="fa fa-check text-success me-3"></i>Interior Vaccuming(Carpet & Seats)</p>
                                 <p><i class="fa fa-check text-success me-3"></i>Engine Oil Replacement</p>
          ...
          <!-- <p class="card-text"><small class="text-muted"><button type="button" class="btn btn-outline-success">Select</button></small></p></small> -->
                ...
                <?php
$result = mysqli_query($con,"SELECT * FROM `service_list` where code='ctt06'");
while($row = mysqli_fetch_assoc($result)){
  ...
  ?>
                <div class="col-lg-3 col-md-6 wow">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Clutch & Transmission Troubles</h5>
                            <small><p class="card-text"> <ul><li>1000 Kms or 1 Month Warranty</li><li>5000 Kms or 3 Months Warranty</li></ul></p>
                                                <p><i class="fa fa-check text-success me-3"></i>Interior Vaccuming(Carpet & Seats)</p>
                                 <p><i class="fa fa-check text-success me-3"></i>Engine Oil Replacement</p>
                            <p><i class="fa fa-check text-success me-3"></i>Oil Filter Replacement</P>
          ...
          <!-- <p class="card-text"><small class="text-muted"><button type="button" class="btn btn-outline-success">Select</button></small></p></small> -->
                ...
                <?php
$result = mysqli_query($con,"SELECT * FROM `service_list` where code='pwcbw06'");
while($row = mysqli_fetch_assoc($result)){
  ...
  ?>
                <div class="col-lg-3 col-md-6 wow">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Problem With Car Brakes & Wheels</h5>
                            <small><p class="card-text"> <ul><li>1000 Kms or 1 Month Warranty</li><li>5000 Kms or 3 Months Warranty</li></ul></p>
                                                <p><i class="fa fa-check text-success me-3"></i>Interior Vaccuming(Carpet & Seats)</p>
                                 <p><i class="fa fa-check text-success me-3"></i>Engine Oil Replacement</p>
                            <p><i class="fa fa-check text-success me-3"></i>Oil Filter Replacement</P>
          ...
          <!-- <p class="card-text"><small class="text-muted"><button type="button" class="btn btn-outline-success">Select</button></small></p></small> -->
                ...
                <?php
$result = mysqli_query($con,"SELECT * FROM `service_list` where code='cei06'");
while($row = mysqli_fetch_assoc($result)){
  ...
  ?>
                <div class="col-lg-3 col-md-6 wow">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Car Engine Issues</h5>
                            <small><p class="card-text"> <ul><li>1000 Kms or 1 Month Warranty</li><li>5000 Kms or 3 Months Warranty</li></ul></p>
                                                <p><i class="fa fa-check text-success me-3"></i>Interior Vaccuming(Carpet & Seats)</p>
                                 <p><i class="fa fa-check text-success me-3"></i>Engine Oil Replacement</p>
                            <p><i class="fa fa-check text-success me-3"></i>Oil Filter Replacement</P>
          ...
          <!-- <p class="card-text"><small class="text-muted"><button type="button" class="btn btn-outline-success">Select</button></small></p></small> -->
                ...
                <?php
$result = mysqli_query($con,"SELECT * FROM `service_list` where code='cwa06'");
while($row = mysqli_fetch_assoc($result)){
  ...
  ?>
                <div class="col-lg-3 col-md-6 wow">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Car Waterlog Assistance</h5>
                            <small><p class="card-text"> <ul><li>1000 Kms or 1 Month Warranty</li><li>5000 Kms or 3 Months Warranty</li></ul></p>
                                                <p><i class="fa fa-check text-success me-3"></i>Interior Vaccuming(Carpet & Seats)</p>
                                 <p><i class="fa fa-check text-success me-3"></i>Engine Oil Replacement</p>
                            <p><i class="fa fa-check text-success me-3"></i>Oil Filter Replacement</P>

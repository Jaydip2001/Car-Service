...
<!-- Navbar End -->
    ...
    <h3><?php include "contactmail.php"?></h3></div>
    <!-- Contact Start -->
 ...
 <div class="col-md-6">
                    <div class="wow">
                        <p class="mb-4">Please Give FeedBack For Better Improvement   <a href="feedback.php">FeedBack</a></p>
                            <form action="#" id="form" method="post" name="form">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                    <input name="vname" placeholder="Your Name" class="form-control" id="name" type="text" value="">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                    <input name="vemail" class="form-control" id="email" placeholder="Your Email" type="text" value="">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                    <input name="sub" class="form-control" id="subject" placeholder="Subject" type="text" value="">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                    <input name="issue" placeholder="issue" class="form-control" type="text" value="">
                                    <!-- <input name="msg" placeholder="message" id="msg"  type="text" value=""> -->
                                ...
                                <!-- <input id="send" name="submit" type="submit" value="Send Message"> -->
                                    <button id="send" name="submit" type="submit" class="btn btn-primary w-100 py-3" type="submit">Send Message</button>
                                </div>
                            </div>
                        </form>

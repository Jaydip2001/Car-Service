...
<!-- Navbar End -->
    ...
    <script type="text/javascript">
        ...
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Please Give Your Feedback </h1>
            </div>
            <div class="row">
...
<th>Submit Form</th>
                    ...
                    <tr>
                        ...
                        <td>
                        <input type="radio" name="quality" value="1"> Bad
                        ...
                        <i class="bi bi-star"></i>
					     <br>
                         <input type="radio" name="quality" value="2"> Poor
                         <i class="bi bi-star-fill"  style="color:red;"></i>
                        <i class="bi bi-starifill" style="color:red;"></i>
                        <i class="bi bi-star"></i>
                        <i class="bi bi-star"></i>
                        <i class="bi bi-star"></i>
                          <br>
                         <input type="radio" name="quality" value="3"> okay 
                         <i class="bi bi-star-fill"  style="color:red;"></i>
                        <i class="bi bi-star-fill" style="color:red;"></i>
                        <i class="bi bi-star-fill" style="color:red;"></i>
                        <i class="bi bi-star"></i>
                        ...
                        <i class="bi bi-star"></i>
                         <br>
                         <input type="radio" name="quality" value="5"> Excellent
                         <i class="bi bi-star-fill"  style="color:red;"></i>
                        <i class="bi bi-star-fill" style="color:red;"></i>
                        <i class="bi bi-star-fill" style="color:red;"></i>
                        <i class="bi bi-star-fill" style="color:red;"></i>
                        <i class="bi bi-star-fill" style="color:red;"></i>
                         ...
                         <td><textarea name=" suggestion" rows="8" cols="40"></textarea></td>
                         <td>
                         <button  name="submit" type="submit" class="btn btn-primary w-100 py-3">Send Response</button>

...
<?php if (!empty($AlreadyAdded)) {  echo $AlreadyAdded; } ?></div>
    ...
    <?php
$result = mysqli_query($con,"SELECT * FROM `service_list` where code='kyp10'");
    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Know Your Policy</h5>
                ...
                <?php
$result = mysqli_query($con,"SELECT * FROM `service_list` where code='dai10'");
while($row = mysqli_fetch_assoc($result)){
  ...
  ?>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <!-- <span class='card-new-top'>50% OFF</span> -->
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Doorstep Accidental Inspection</h5>
                            <small><p class="card-text"> <ul><li>1000 Kms or 1 Month Warranty</li><li>5000 Kms or 3 Months Warranty</li></ul></p>
                                                <p><i class="fa fa-check text-success me-3"></i>Interior Vaccuming(Carpet & Seats)</p>
                                 <p><i class="fa fa-check text-success me-3"></i>Engine Oil Replacement</p>
                            <p><i class="fa fa-check text-success me-3"></i>Oil Filter Replacement</P>
          ...
          <!-- <p class="card-text"><small class="text-muted"><button type="button" class="btn btn-outline-success">Select</button></small></p></small> -->
                ...
                <?php
$result = mysqli_query($con,"SELECT * FROM `service_list` where code='wr10'");
while($row = mysqli_fetch_assoc($result)){
  ...
  ?>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Windsjield Replacement (Insurance)</h5>
                            <small><p class="card-text"> <ul><li>1000 Kms or 1 Month Warranty</li><li>5000 Kms or 3 Months Warranty</li></ul></p>
                                                <p><i class="fa fa-check text-success me-3"></i>Interior Vaccuming(Carpet & Seats)</p>
                                 <p><i class="fa fa-check text-success me-3"></i>Engine Oil Replacement</p>
                            <p><i class="fa fa-check text-success me-3"></i>Oil Filter Replacement</P>
          ...
          <!-- <p class="card-text"><small class="text-muted"><button type="button" class="btn btn-outline-success">Select</button></small></p></small> -->
                ...
                <?php
$result = mysqli_query($con,"SELECT * FROM `service_list` where code='ti10'");
while($row = mysqli_fetch_assoc($result)){
  ...
  ?>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Towing (Insurance)</h5>
                            <small><p class="card-text"> <ul><li>1000 Kms or 1 Month Warranty</li><li>5000 Kms or 3 Months Warranty</li></ul></p>
                                                <p><i class="fa fa-check text-success me-3"></i>Interior Vaccuming(Carpet & Seats)</p>
                                 <p><i class="fa fa-check text-success me-3"></i>Engine Oil Replacement</p>
                            <p><i class="fa fa-check text-success me-3"></i>Oil Filter Replacement</P>
          ...
          <!-- <p class="card-text"><small class="text-muted"><button type="button" class="btn btn-outline-success">Select</button></small></p></small> -->
                ...
                <?php
$result = mysqli_query($con,"SELECT * FROM `service_list` where code='tr10'");
while($row = mysqli_fetch_assoc($result)){
  ...
  ?>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Tyre Replacement (Insurance)</h5>
                            <small><p class="card-text"> <ul><li>1000 Kms or 1 Month Warranty</li><li>5000 Kms or 3 Months Warranty</li></ul></p>
                                                <p><i class="fa fa-check text-success me-3"></i>Interior Vaccuming(Carpet & Seats)</p>
                                 <p><i class="fa fa-check text-success me-3"></i>Engine Oil Replacement</p>
                            <p><i class="fa fa-check text-success me-3"></i>Oil Filter Replacement</P>
          ...
          <!-- <p class="card-text"><small class="text-muted"><button type="button" class="btn btn-outline-success">Select</button></small></p></small> -->
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden"></div></div></div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden"></div></div></div>
                <?php
$result = mysqli_query($con,"SELECT * FROM `service_list` where code='ic10'");
while($row = mysqli_fetch_assoc($result)){
  ...
  ?>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        ...
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Insurance Claim</h5>
                            <small><p class="card-text"> <ul><li>1000 Kms or 1 Month Warranty</li><li>5000 Kms or 3 Months Warranty</li></ul></p>
                                                <p><i class="fa fa-check text-success me-3"></i>Interior Vaccuming(Carpet & Seats)</p>
                                 <p><i class="fa fa-check text-success me-3"></i>Engine Oil Replacement</p>
                            <p><i class="fa fa-check text-success me-3"></i>Oil Filter Replacement</P>

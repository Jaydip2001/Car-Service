        ...
        <?php 
                        ...
                        ?>
                         <div class="dynamic_alert alert alert-<?php echo $_SESSION['flashdata']['type'] ?> my-2 rounded-0">
                            <div class="d-flex align-items-center">
                                ...
                                </div class="btn btn-primary bg-gradient rounded-0">
                            </div>
                        </div>
            ...
            <div class="row g-3">
                ...
                <!-- <label for="email" class="label-control">Email</label> -->
                               <input type="email" name="email" id="email" placeholder="Enter Your Email" style="height: 55px;" class="form-control rounded-0" value="<?= isset($_POST['email']) ? $_POST['email'] : '' ?>" autofocus required>
                </div>
                <div class="col-12 col-sm-6">
                   
                <!-- <label for="password" class="label-control">Password</label> -->
                               <input type="text" name="password" id="password" placeholder="Enter Your Password" style="height: 55px;" class="form-control rounded-0" value="<?= isset($_POST['password']) ? $_POST['password'] : '' ?>" required>
                </div>
               
                <div class="col-12">
                <button type="submit" class="btn btn-secondary w-50 py-3" >Login</button>
                </div>
           
            <p>
            <a href="./registration.php" class="text-white mb-0">Create a New Account</a></p>
            <a href="./forgot-password.php" class="text-white mb-0">forgot-password?</a></p>

...
<div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="text-primary text-uppercase">//  Orders //</h6>
                <h1 class="mb-5">CART</h1>
            </div>
                <!-- <br> -->
     <!-- <center> <h1 class="wthree_text_info">Edit <span>Cart</span></h1></center>     -->
      	<?php
...
<span><button type="submit" class="btn btn-default btn-xs" style="background: #b66; color: #fff;" onChange="this.form.submit()">Update</button></span>
</form>
      </td>
      <td>
...
<tr>
 ...
 <a href="service.php"><button type="button" class="btn btn-success" style="float: left;" data-dismiss="modal">select another service</button></a>
      <a href="booking.php"><button type="button" class="btn btn-primary">Proceed to book services</button></a>
  </td>
</tr>

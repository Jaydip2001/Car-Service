        ...
        <?php 
            ...
            <div class="row g-3">
                ...
                <!-- <label for="firstname" class="label-control">First Name</label> -->
                             <input type="text" placeholder="Enter Fullname" name="firstname" id="firstname" class="form-control rounded-0" value="<?= isset($_POST['firstname']) ? $_POST['firstname'] : '' ?>" style="height: 55px;"  autofocus required>

                </div> 
                <div class="col-12 col-sm-6">
                    
  		                <!-- < <label for="email" class="label-control">Email</label> -->
                               <input type="email" placeholder="Enter Email" name="email" id="email" class="form-control rounded-0" style="height: 55px;" value="<?= isset($_POST['email']) ? $_POST['email'] : '' ?>" required>
        	</p>             
                    </div>
                    <script>
  ...
  if(myInput.value.length >= 8) {
    ...
    length.classList.add("invalid");
                ...
                <!-- <label for="password" class="label-control">Password</label> -->
                               <input type="password" name="password" placeholder="Enter Password" id="password"  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" style="height: 55px;" class="form-control rounded-0" value="<?= isset($_POST['password']) ? $_POST['password'] : '' ?>" required>
                </div>
                ...
                <!-- <label for="password" class="label-control">Password</label> -->
                <input type="tel" name="mno" id="mno" class="form-control border-0" placeholder="Enter Your mobile number" style="height: 55px;"  required>
                </div> 
                <!-- <div class="col-12 col-sm-6">  -->
                <div class="col-12 col-sm-6">
                                <!-- <p></p> -->
                                    <!-- <input type="text" name="sname" class=" form-control border-0"  style="height: 55px;"> -->
                                    <select  name="cartype" id="cartype" class="service form-select border-0" value="<?= isset($_POST['cartype']) ? $_POST['cartype'] : '' ?>" style="height: 55px;"> 
  		                ...
  		                <!-- <input type="textfield" name="address" class="form-control border-0" placeholder="Enter Your Address" style="height: 55px;"> -->
                <!-- </div> -->
		 		<!--<div class="col-12 col-sm-6">
                   
				   <input type="password" name="password_2" class="form-control border-0" placeholder="Confirm password" style="height: 55px;">
		 		</div>
				...
				<div class="col-12 col-sm-6">
				   ...
				   <input type="text" name="city" class="form-control border-0" placeholder="Enter Your City" style="height: 55px;">
		 </div> -->
         
         <div class="clearfix"> </div>
                <div class="col-12">
                <button type="submit" class="btn btn-secondary w-50 py-3">Register</button>
                <!-- <button class="btn btn-primary bg-gradient rounded-0">Create Account</button> -->
                </div>
            
            <p>
			      Already a member? <a href="login.php" class="text-white mb-0">Sign in</a>
        	</p>
        </form>
        </div>
    </div>

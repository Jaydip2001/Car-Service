...
<!-- Navbar End -->
    ...
    <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Please Enter Your Email-Id </h1>
            </div>
    <?php
// session_start();
...
if(isset($_POST['submit']))
{
	...
	if($email==$fetch_email) {
				$to = $email;
                $subject = "Password";
                $txt = "Your password is : $password.   use this password for login and than change passowrd in website." ;
                $headers = "From: jadejadivyarajsinhc@gmail.com";
...
?>
    ...
    <div class="bg-primary h-100 d-flex flex-column justify-content-center text-center p-5 wow zoomIn" data-wow-delay="0.6s">
                       <form action="" method="POST">
                            ...
                            <!-- <button type='submit' name='submit' value='Submit' class="btn btn-warning">Confirm</button> -->
                                <!-- <button class="btn btn-outline bg-gradient rounded-0" type='submit' name='submit' value='Submit'>Confirm</button> -->
                            </div>
                       </form></center>
                   </div>
               </div>
